...
export const RULEBOOK: RuleSection[] = [
  {
    ...
    clauses: [
      ...
      { n: '5.4', title: 'The draw', body: 'Brackets close and are drawn in two groups. Group A is the ten clubs that finished in last season\u2019s top ten; Group B is the remaining ten. Each group closes when its own draw is announced, and no closing date is published in advance. Within a group, all ten Brackets are drawn at random on a single live broadcast. The draw is not seeded. Only entries confirmed with an identity number before that draw are included in it.' },
  ...
  },
  {
    ...
    clauses: [
      { n: '6.1', title: 'Game and platform', body: 'Qualifiers are played on EA SPORTS FC 26; the Season is played on EA SPORTS FC 27. Both on PlayStation 5, on hardware supplied by the Organiser. Three clubs promoted this summer are not selectable in FC 26, so their Brackets are played using the club each replaced \u2014 Coventry City as West Ham United, Ipswich Town as Burnley, Hull City as Wolverhampton. The entrant wins the Club Slot itself and represents their real club from Gameweek 1.' },
