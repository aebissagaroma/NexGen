    ...
    if (session.email) {
      await sendMail({
        ...
        text: [
          ...
          'Registration is free of charge. A qualifier session fee is payable online in',
          'advance of your scheduled session, and covers venue hire, tournament hardware,',
