    ...
    if (session.email) {
      await sendMail({
        ...
        text: [
          ...
          'Registration is free. A qualifier session fee is payable in person at the',
          'Qualifier Center on match day — it covers venue, tournament hardware,',
          'officials and stream. The amount is announced before registration closes.',
          '',
