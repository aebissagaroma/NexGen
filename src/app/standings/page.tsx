  ...
  return (
    <>
      ...
      <div className="page-wrap">
        <PageTitle file="FILE/06 · TABLE" title={<>LEAGUE<br /><span style={{ color: 'var(--accent-glow)' }}>TABLE.</span></>} sub="38 gameweeks, round-robin. The table populates once the season kicks off on 10 November 2026." />
        {loading ? (
          ...
          <div className="ticks" style={{ position: 'relative', border: '1px solid var(--line-2)', minHeight: 240, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 12, textAlign: 'center', padding: 40, background: 'var(--bg-1)' }}>
            ...
            <div className="display" style={{ fontSize: 'clamp(28px,4vw,48px)' }}>KICKOFF · 10 NOV 2026</div>
          </div>
        ) : (
