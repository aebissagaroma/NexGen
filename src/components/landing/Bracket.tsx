...
const ROUNDS = [
  ...
  { round: 'RD 256', date: 'TBA' }, { round: 'RD 64', date: 'TBA' },
      ...
      <div className="wrap">
        <div className="section-head" data-reveal>
          <div className="section-head-row">
            ...
            <p className="section-sub" style={{ alignSelf: 'flex-end' }}>Each of the 20 club brackets is a single-elimination knockout, BO3 throughout. Brackets are drawn at random live on broadcast the day after qualifier registration closes — <strong style={{ color: 'var(--ink)' }}>date announced nearer the time</strong>.</p>
          </div>
        </div>
        ...
        <div data-reveal style={{ marginTop: 28, display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 0, border: '1px solid var(--line)' }} className="bracket-rail">
          {[{ k: 'FORMAT', v: 'BO3 · KO' }, { k: 'ROUNDS', v: 'UP TO 8' }, { k: 'SEEDING', v: 'RANDOM DRAW' }, { k: 'BROADCAST', v: 'TIKTOK · YT · IG' }].map((r, i) => (
