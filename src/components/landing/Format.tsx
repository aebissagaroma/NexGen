...
const STEPS: Step[] = [
  { n: '01', kicker: 'PHASE ONE', title: 'QUALIFIERS', sub: 'OPEN NATIONAL BRACKETS', blurb: 'Sign up for any club you want to represent. Each club runs its own knockout bracket — best of three, single elimination — until one player wins the slot.', meta: [{ k: 'FORMAT', v: 'BO3 KO' }, { k: 'ENTRY', v: '500 ETB' }, { k: 'BRACKETS', v: '20' }, { k: 'OPENS', v: 'JUN 01' }], state: 'upcoming' },
  { n: '02', kicker: 'PHASE TWO', title: 'DRAFT DAY', sub: '20 SLOTS · 1 BROADCAST', blurb: 'On Draft Day all 20 winners are announced on a single live broadcast. Each is paired with their Premier League club for the season — jersey reveal, profile film, and seeding.', meta: [{ k: 'DATE', v: 'JUL 18' }, { k: 'VENUE', v: 'TBA' }, { k: 'BROADCAST', v: 'EBS · YT' }, { k: 'STATUS', v: 'LOCKED' }], state: 'upcoming' },
  { n: '03', kicker: 'PHASE THREE', title: 'SEASON', sub: '38 GAMEWEEKS · ROUND ROBIN', blurb: 'All 20 players play each other home and away — exactly 38 fixtures each. League table, top scorer race, GW awards, and a televised final at the host venue.', meta: [{ k: 'FIXTURES', v: '190' }, { k: 'WEEKS', v: '38' }, { k: 'KICKOFF', v: 'AUG 15' }, { k: 'FINAL', v: 'MAY 2027' }], state: 'upcoming' },
];
